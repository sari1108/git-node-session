            ...
            items: [
                {
                    ...
                    template: (item, options) => (
                        ...
                        >
                            <img src="images/9523642.gif" alt="בית" width={20} />
    ...
    return (
        <div className='productpage' style={{ position: 'relative' }}>
            ...
            <div className="grid grid-nogutter justify-center gap-8 card" style={{
                ...
                <DataView value={products.filter((prod)=>{return prod.category == "BabyProducts"})} listTemplate={listTemplate} layout={layout} />
            </div>
        </div>
    )
}
