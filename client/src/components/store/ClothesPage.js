            ...
            items: [
                {
                    ...
                    template: (item, options) => (
                        ...
                        >
                            <img src="/images/6427720.png" alt="בית" width={20} />
                ...
                },
                {
                    ...
                    template: (item, options) => (
                        ...
                        >
                            <img src="/
                            images/logooo.gif" alt="בית" width={20} />
                            <span className="font-bold">{item.label}</span>
                        </button>
                    )
    ...
    return (
        <div className='productpage' style={{ position: 'relative' }}>
            ...
            <div className="grid grid-nogutter justify-center gap-8 card" style={{
                ...
                <DataView value={products.filter((prod) => { return prod.category == "BabyClothes" })} listTemplate={listTemplate} layout={layout} />
            </div>
        </div>
    )
}
